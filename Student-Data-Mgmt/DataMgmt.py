...
main = Tk()
main.title('Simple School Management System')
main.geometry('1000x600')
main.resizable(0, 0)
# Creating the background and foreground color variables
lf_bg = 'Bisque' # bg color for the left_frame
cf_bg = 'BurlyWood' # bg color for the center_frame
...
Label(main, text="SCHOOL MANAGEMENT SYSTEM", font=headlabelfont, bg='GoldenRod').pack(side=TOP, fill=X)
...
Label(right_frame, text='Students Records', font=headlabelfont, bg='Moccasin', fg='NavajoWhite').pack(side=TOP, fill=X)
