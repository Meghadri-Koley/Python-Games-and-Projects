...
when = [
  ...
  "Yesterday", "Last night", "On 1st Jan", "On 2nd Feb", "On 3rd March", "On 4th April",
  "On 5th May", "On 6th June", "On 7th July", "On 8th Aug", "On 9th Sept", "On 10th Oct",
  "On 11th Nov", "On 12th Dec"
]
...
went = ['cinema', 'university','seminar', 'school', 'laundry', 'playground', 'shopping mall', 'fashion store', 'fast food restaurant', 'city hall', 'town hall', 'cookhouse', 'beach', 'zoo', 'amusement park', 'college', 'fun fair', 'food fair']
